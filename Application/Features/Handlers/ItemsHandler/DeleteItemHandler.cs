...
{
    public class DeleteItemHandler : IRequestHandler<DeleteItemCommand, Response<bool>>
    {
        private readonly IItem _repository;
        public DeleteItemHandler(IItem repository)
        {
            _repository = repository;
        }
        public async Task<Response<bool>> Handle(DeleteItemCommand request, CancellationToken cancellationToken)
        {
